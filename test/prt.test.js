...
describe("PRT", () => {
  ...
  describe("mintPRT", () => {
    it("should revert if the deposit criteria hasn't been met", async () => {
    ...
    it("should revert if the borrow criteria hasn't been met", async () => {
      const liquidityAmount = wei(10000);
      const amountToBorrow = wei(3000);
      let price = wei(1, 7);
    ...
    it("should revert if not enouth time has passed since the creteria fullfilled", async () => {
      const liquidityAmount = wei(10000);
      const amountToBorrow = wei(3000);
      let price = wei(1, 7);
